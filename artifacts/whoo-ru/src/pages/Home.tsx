      ...
      <section className="relative min-h-[85vh] flex items-center pt-10 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground font-light leading-relaxed mb-12 max-w-3xl mx-auto">
              How can something that examines the tiniest of components solve society's largest of problems? Quantum qubits cannot even be seen by the human eye. And neither can the beliefs you hold. I am developing a formal system to map a person's beliefs using theories based in quantum mechanics. When examined at scale, these results expose the underlying patterns driving cultural change — and, ultimately, cultivate the collective empathy required to confront wicked problems once and for all.
            </p>
