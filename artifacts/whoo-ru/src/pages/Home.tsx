        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground font-light leading-relaxed mb-10">
              ...
              They begin with a new capacity to understand belief at scale.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: Users,
                title: "AI Alignment",
                desc: "Train AI companions that actually understand your context by giving them the precise coordinates of your worldview.",
                color: "text-accent",
                bg: "bg-accent/10"
              }
            ].map((feature, i) => (
