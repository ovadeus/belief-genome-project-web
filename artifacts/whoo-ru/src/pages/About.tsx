            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  The Belief Genome Project is spearheaded by David Edwin Meyers, a creative polymath, researcher, developer, and writer who has spent over four decades exploring the intersection of art, technology, psychology, and human self-understanding.
                </p>
