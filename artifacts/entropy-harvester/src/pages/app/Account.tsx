...
import { useEhGetMe, useEhLogout, type EhMe } from "@workspace/api-client-react";
...
export default function Account() {
  ...
  return (
    <AppLayout>
      {me ? (
        <AccountContent me={me} handleLogout={handleLogout} logout={logout} />
      ) : null}
    </AppLayout>
  );
}
...
type AccountContentProps = {
  me: EhMe;
  handleLogout: () => void;
  logout: ReturnType<typeof useEhLogout>;
};

function AccountContent({ me, handleLogout, logout }: AccountContentProps) {
  return (
