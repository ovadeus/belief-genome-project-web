 ...
 *
 * Two independent layers combine to produce realistic aggregate data:
 *
 * 1. DEMOGRAPHIC ARCHETYPES (12 profiles based on Pew, WVS, Ipsos, PRRI)
 *    provide country, gender, age distribution, and signature dim overrides
 *    (e.g. Indian Hindu keeps religion=9 regardless of week; Nordic Secular
 *    keeps LGBTQ+=9 regardless of week).
 *
 * 2. PER-CATEGORY TEMPORAL TRAJECTORIES reflect actual documented trends
 *    (religion declining, LGBTQ acceptance rising, tech optimism falling,
 *    politics polarizing, economics shifting post-pandemic, etc.) — each
 *    category has its OWN independent shape, so the timeline chart shows
 *    categories crossing, diverging, and following different peaks/valleys.
 *
 * All rows insert with is_test_data = true. Remove with cleanup-test-data.ts.
 */
...
/**
 * Per-category temporal trajectories in DISPLAY units (-4 to +4).
 * Index 0 = 13 weeks ago, index 13 = current week.
 * Each curve is INDEPENDENT — shapes reflect real-world trends:
 *   - Spirituality: steady secularization (Pew 2007-2024 decline in religion)
 *   - Social: progressive lift (LGBTQ+ acceptance, gender egalitarianism)
 *   - Politics: populist wobble with slight right turn then correction
 *   - Economics: post-pandemic left drift (welfare state rising)
 *   - Science_tech: declining tech optimism (AI anxiety, social-media backlash)
 *   - Health: rising body autonomy + mental health normalization
 *   - Relationships: slow erosion of traditional family norms
 *   - Epistemology: rising skepticism of experts
 *   - Education: college-value skepticism
 *   - Psychology: therapy/self-awareness rising
 *   - Morality: relatively stable (deep cultural anchor)
 */
...
interface ArchetypeProfile {
  ...
  /** Signature dim overrides applied regardless of temporal trajectory (0-9 scale) */
  dimSignatures: Record<number, number>;
  /** Weight toward signatures vs trajectory; 0 = pure trajectory, 1 = pure signature */
...
const PROFILES: Record<Archetype, ArchetypeProfile> = {
  us_evangelical_boomer: {
    ...
    dimSignatures: {
      ...
      35: 1, 36: 8, 48: 9, 50: 9, 52: 9, 61: 9,
      64: 9, 65: 9, 70: 2, 71: 8, 72: 1, 74: 8, 75: 1,
      119: 9, 120: 9, 121: 9,
    },
  ...
  us_secular_millennial_urban: {
    ...
    dimSignatures: {
      14: 2, 15: 2, 22: 1, 35: 9, 38: 9,
      52: 2, 54: 9, 55: 9, 70: 9, 73: 9, 84: 9, 85: 7,
      96: 8, 106: 9, 108: 9,
    },
  ...
  us_rural_conservative: {
    ...
    dimSignatures: {
      14: 9, 15: 8, 48: 9, 50: 8, 52: 9, 53: 8, 54: 2, 55: 2, 57: 2, 58: 9, 59: 9,
      64: 9, 65: 9, 70: 2, 82: 2, 94: 3, 96: 9,
    },
    signatureStrength: 0.70,
    skipRate: 0.07,
  },
  us_genz_progressive: {
    ...
    dimSignatures: {
      14: 1, 15: 1, 22: 1, 35: 9, 38: 9,
      52: 1, 54: 9, 55: 9, 68: 9, 70: 9, 73: 9, 76: 9,
      82: 9, 84: 9, 85: 9, 94: 9, 106: 9, 108: 9,
    },
    signatureStrength: 0.70,
    skipRate: 0.04,
  },
  nordic_secular_progressive: {
    ...
    dimSignatures: {
      14: 1, 15: 1, 16: 2, 18: 1, 22: 1, 23: 1,
      35: 9, 51: 9, 54: 9, 55: 8, 57: 8, 70: 9, 73: 8,
      80: 9, 81: 9, 84: 9, 85: 8, 94: 9, 108: 9,
    },
    signatureStrength: 0.75,
    skipRate: 0.03,
  },
  german_social_dem: {
    ...
    dimSignatures: {
      14: 3, 22: 2, 51: 9, 54: 9, 57: 8, 70: 8, 80: 9, 81: 9, 84: 9, 96: 9, 108: 9,
    },
  ...
  indian_traditional_hindu: {
    ...
    dimSignatures: {
      14: 9, 15: 9, 17: 9, 19: 9, 20: 9, 22: 9, 27: 9, 28: 9,
      64: 9, 65: 9, 66: 8, 71: 8, 77: 9,
      51: 7, 84: 6,
      119: 9, 120: 9, 121: 9, 122: 9,
    },
    signatureStrength: 0.80,
    skipRate: 0.08,
  },
  ...
  brazilian_evangelical_right: {
    ...
    dimSignatures: {
      14: 9, 15: 9, 16: 9, 22: 9, 23: 9,
      50: 8, 52: 8, 56: 9, 64: 9, 65: 9, 70: 2, 71: 8, 119: 9, 120: 9,
    },
    signatureStrength: 0.70,
    skipRate: 0.07,
  },
  mexican_catholic_populist: {
    ...
    dimSignatures: {
      14: 9, 15: 8, 16: 9, 17: 9, 22: 7, 51: 8, 64: 8, 65: 8, 80: 8, 85: 7,
      119: 8, 120: 8,
    },
    signatureStrength: 0.60,
    skipRate: 0.07,
  },
  uk_pragmatic_centrist: {
    ...
    dimSignatures: {
      14: 3, 22: 3, 51: 7, 54: 7, 70: 7, 108: 9,
    },
    signatureStrength: 0.35,
    skipRate: 0.06,
  },
  french_laicite_left: {
    ...
    birthYearRange: [1955, 2003],
    dimSignatures: {
      14: 2, 15: 1, 22: 1, 26: 2, 51: 9, 54: 8, 57: 9, 70: 8, 80: 9, 84: 9, 108: 9,
    },
    signatureStrength: 0.65,
    skipRate: 0.05,
  },
...
/** Static archetype mix — no temporal drift here; time is controlled by TRAJECTORIES. */
...
function sampleDimValue(profile: ArchetypeProfile, dimId: number, weekIdx: number): string {
  ...
  const trajectoryDisplay = TRAJECTORIES[cat][weekIdx];  // -4..+4 display
  const trajectoryRaw = trajectoryDisplay + 5;            // 0..9 raw
  ...
  // Per-user variance so within-week populations still span the scale
...
async function main() {
  ...
  const total = USERS_PER_WEEK * WEEKS;
  console.log(`[seed] Generating ${total} submissions across ${WEEKS} weekly buckets.`);
  console.log(`[seed] Using ${Object.keys(PROFILES).length} archetypes + independent per-category temporal trajectories.`);
  ...
  for (let weeksAgo = WEEKS - 1; weeksAgo >= 0; weeksAgo--) {
    ...
    for (let i = 0; i < USERS_PER_WEEK; i++) {
  ...
  for (const [a, n] of Object.entries(archetypeCounts).sort((a, b) => b[1] - a[1])) {
    console.log(`  ${PROFILES[a as Archetype].label.padEnd(38)} ${String(n).padStart(5)}`);
  }
  console.log(`\n[seed] === Category trajectories (display units, week-13 → week-0) ===`);
  for (const [cat, curve] of Object.entries(TRAJECTORIES)) {
    console.log(`  ${cat.padEnd(14)} ${curve.map(v => (v>=0?'+':'')+v.toFixed(1)).join('  ')}`);
  }
